...
Swagger-Akka-Http brings [Swagger](https://swagger.io/swagger-core/) support for [Akka-Http](https://doc.akka.io/docs/akka-http/current/index.html) Apis. The included `SwaggerHttpService` route will inspect Scala types with Swagger annotations and build a swagger compliant endpoint for a [swagger compliant ui](https://petstore.swagger.io/).
...
Adding such a UI to your akka-http app is easy. 
[gerbrand/swagger-akka-http-with-ui-sample](https://github.com/gerbrand/swagger-akka-http-with-ui-sample) does it using libs from org.webjars.
